...
> **Version:** V3.3 (2026-07-05) — Backend integration. Frontend integration documented in V3.4.
> **Frontend Integration:** See `NOMBA_PRD_V3_FRONTEND_INTEGRATION.md` (V3.4) for complete frontend documentation including tenant payment flow, landlord disbursement flow, payment history, and UI components.
